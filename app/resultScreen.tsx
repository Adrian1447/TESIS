  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.containerResult}>
        <Image source={require('@/assets/images/RectangleResultScreen.png')} style={{width: 320}}/>
        <View style={styles.heartRateContainer}>
          <Image source={require('@/assets/images/heart.png')} style={{width:55, height:55, right:55, top:10}}/>
      ...
      <View style={styles.statusContainer}>
        {['Standing', 'Stretching', 'Resting', 'Exercise'].map((status, index) => (
